...
export const getDAO = (providerOrSigner: ethers.Provider | ethers.Signer) =>
  new ethers.Contract(`${process.env.NEXT_PUBLIC_DAO_CONTRACT_ADDRESS}`, daoAbi, providerOrSigner);
...
export const getFarmEscrow = (providerOrSigner: ethers.Provider | ethers.Signer) =>
  new ethers.Contract(
...
export const getInvestment = (providerOrSigner: ethers.Provider | ethers.Signer) =>
  new ethers.Contract(
